...
const w = new function () {
  ...
  this.prompt = function (info, options = {}) {
      ...
      if (noclose) {
        ...
        if (show_close) {
          w[closedom].innerHTML = typeof show_close === 'string' ? show_close : `<div style="color:#a7a8a9;font-size:185%;z-index:3;position:fixed;width:100%;left:0;text-align:center;bottom:${wh === 'bottom' ? 82 : 8}%;cursor:pointer;text-shadow:2px 2px 5px #c1c2c3;">🗙</div>`
        }
