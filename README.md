...
> 在目前，我十分不建议开发者使用此框架开发正式产品，因为它还处在比较剧烈的大版本更新上。我的计划是到2024年，我会根据我正在开发的应用，发现问题，并改进设计，直到一个稳定的方案为止。
...
浏览器访问的端口号是可以通过config/config.js配置文件更改的。
