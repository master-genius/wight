...
只是为了方便自己使用的一个前端小框架，前端热门的react、vue等，我一概不会，并且实在是不想去学这些东西。我主要是开发后端服务以及Linux运维和服务管理相关的工具。可是又离不开前端应用，于是开发了wight框架，后来几次更新升级，到2021年底，做了一些不兼容修改，并且支持web components。
